                    ...
                    <div class="col-sm-9">
                        <!-- cart item -->
                            <div class="row border-top py-3 mt-3">
                                <div class="col-sm-2">
                                    <img src="./assets/products/1.PNG" style="height: 90px;" alt="cart1" class="img-fluid">
                                </div>
                                <div class="col-sm-8">
                                    <h5 class="font-baloo font-size-20">Dell Inspiron 14 2-in-1</h5>
                                    <small>by Dell</small>
                                    <!-- product rating -->
                                    <div class="d-flex">
                                    ...
                                    <!-- product qty -->
                                        <div class="qty d-flex pt-2">
                                            ...
                                            <button type="submit" class="btn font-baloo text-danger">Save for Later</button> <!-- not necessary -->
                                        </div>
                                    <!-- !product qty -->
                        ...
                        <div class="row border-top py-3 mt-3">
                            <div class="col-sm-2">
                                <img src="./assets/products/2.PNG" style="height: 90px;" alt="cart1" class="img-fluid">
                            </div>
                            <div class="col-sm-8">
                                <h5 class="font-baloo font-size-20">Asus ZenBook 17 Fold OLED UX9702</h5>
                                <small>by Asus</small>
                                <!-- product rating -->
                                <div class="d-flex">
                                    <div class="rating text-warning font-size-12">
                                    ...
                                    <a href="#" class="px-2 font-rale font-size-14">11 ratings</a>
                                </div>
                                <!--  !product rating-->
