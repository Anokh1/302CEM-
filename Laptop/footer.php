    ...
    <!-- start #footer -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-12">
                        <h4 class="font-rubik font-size-20">Agile Laptop</h4>
                        <p class="font-size-14 font-rale text-white-50">302CEM Agile Methodology Coursework August 2022</p>
                    </div>
        ...
        <div class="copyright text-center bg-dark text-white py-2">
            <p class="font-rale font-size-14">&copy; Copyright 2022. Agile Laptop</p>
        </div>
    <!-- !start #footer -->
